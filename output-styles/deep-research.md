...
**Deep Pattern Analysis**: Deploy context-engineer for semantic understanding across large codebases where simple searches miss conceptual connections.
...
<parameter name="subagent_type">context-engineer</parameter>
</invoke>
<invoke name="Task">
...
**Analysis & Synthesis**:
- `Task(context-engineer)`: Semantic code understanding, architectural analysis
...
6. **Complex pattern analysis?** → Deploy context-engineer for semantic understanding
